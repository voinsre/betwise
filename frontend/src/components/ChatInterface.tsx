          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            {isLoading && (
              <div className="flex gap-3">
                <div className="w-8 h-8 rounded-full bg-brand-card border border-brand-border flex items-center justify-center flex-shrink-0">
                  <span className="text-xs font-bold text-accent-green">BW</span>
                </div>
...
function EmptyState({ onAction }: { onAction: (msg: string) => void }) {
  return (
    <div className="flex flex-col items-center justify-center h-full max-w-md mx-auto text-center">
      ...
      <h2 className="text-xl font-bold text-white mb-2">BetWise AI</h2>
